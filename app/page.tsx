...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[var(--br-canvas-elevated)] text-[var(--br-dark-card)]">
      <section className="relative flex min-h-[760px] items-center overflow-hidden bg-[var(--br-canvas)] pt-16 lg:min-h-[820px] lg:pt-24">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -right-[10%] -top-[20%] h-[80%] w-[60%] rounded-full bg-gradient-to-br from-[var(--br-surface-muted)] via-[var(--br-surface-muted)] to-transparent opacity-60 blur-[120px]" />
          <div className="absolute -bottom-[10%] -left-[5%] h-[60%] w-[40%] rounded-full bg-gradient-to-tr from-[var(--br-surface-muted)] via-[var(--br-surface-muted)] to-transparent opacity-40 blur-[100px]" />
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-[1440px] gap-8 px-6 py-12 sm:px-12 lg:grid-cols-[45%_55%] lg:items-center lg:px-12 lg:py-16">
          <div className="flex max-w-[540px] flex-col items-start">
            <span className="rounded-full border border-[var(--br-border)] bg-[var(--br-surface-muted)] px-3 py-1 text-xs font-medium uppercase tracking-[0.15em] text-[var(--br-text-muted)]">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <Link href="/level-test" className="rounded-xl border-2 border-[var(--br-brand)] px-7 py-4 text-base font-bold text-[var(--br-brand)] transition-colors hover:bg-[var(--br-surface)]">
                Take a Level Test
              </Link>
            </div>
          ...
          <div className="relative flex h-[500px] w-full items-center justify-center sm:h-[600px]">
            <div className="absolute h-[80%] w-[80%] -translate-y-10 rounded-full bg-[var(--br-surface-muted)] opacity-50 blur-[40px]" />
            ...
            <div className="hero-float absolute right-[2%] top-[5%] z-30 min-w-[160px] rounded-xl border border-white/40 bg-white/85 p-4 shadow-md backdrop-blur sm:right-[5%] sm:min-w-[180px]">
              ...
              <div className="flex items-end gap-1"><span className="font-mono text-3xl font-semibold text-[var(--br-text)]">87</span><span className="pb-1 text-xs text-[var(--br-text-muted)]">/100</span></div>
            ...
            <div className="hero-float absolute bottom-[15%] left-0 z-30 hidden items-center gap-3 rounded-full border border-white/40 bg-white/85 p-3 pr-5 shadow-md backdrop-blur sm:flex">
              <div className="grid size-10 place-items-center rounded-full border-2 border-white bg-[var(--br-surface-muted)] text-sm shadow-sm">★</div><p className="text-xs font-medium italic text-[var(--br-brand)]">“I can express my ideas clearly now!”</p>
            </div>
      ...
      <section className="bg-[var(--br-surface)] px-6 py-16 sm:py-20">
      ...
      <section className="bg-[var(--br-surface-muted)] px-6 py-16 sm:py-20">
      ...
      <section className="bg-surface px-6 py-16 sm:py-20">
        <div className="relative mx-auto max-w-[1200px] overflow-hidden rounded-[20px] bg-[var(--br-text)] p-8 text-on-dark shadow-[var(--br-shadow)] md:p-16">
          <div className="pointer-events-none absolute -right-32 -top-56 size-[600px] rounded-full bg-[var(--br-action)]/20 blur-[120px]" />
          <div className="relative z-10 grid gap-10 md:grid-cols-2 md:items-center"><div><span className="text-xs font-bold uppercase tracking-[.18em] text-[var(--br-action)]">Quick Assessment</span><h2 className="mt-3 text-4xl font-bold tracking-tight sm:text-5xl">Find your CEFR level in 15 minutes.</h2><p className="mt-5 max-w-xl font-serif text-lg leading-7 text-[var(--br-text-muted)]">Our intelligent level test analyzes your pronunciation, vocabulary, and grammar in real-time to place you in the perfect learning bracket.</p><Link href="/level-test" className="mt-7 inline-flex rounded-xl bg-surface px-8 py-4 text-lg font-bold text-[var(--br-text)] transition hover:bg-[var(--br-surface-muted)]">Start Test <ArrowRight className="ml-2 mt-0.5 size-5" /></Link></div><div className="hidden justify-center md:flex"><div className="relative grid size-64 place-items-center rounded-full border-4 border-white/10"><div className="grid size-48 place-items-center rounded-full border-4 border-[var(--br-action)] text-center"><span className="text-5xl font-bold text-[var(--br-action)]">B2</span><span className="text-xs text-[var(--br-border)]">Upper-Intermediate</span></div><span className="absolute -top-5 grid size-10 place-items-center rounded-full bg-surface text-[var(--br-text)] shadow-lg"><CheckCircle2 className="size-5" /></span></div></div></div>
        </div>
      </section>
    </main>
  );
