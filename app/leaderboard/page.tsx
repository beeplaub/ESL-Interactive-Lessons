    ...
    <LearnerAppShell active="leaderboard" showRightSidebar>
      <div className="max-w-[1440px] mx-auto space-y-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-[var(--br-surface-strong)]/60 flex items-center gap-6 group hover:shadow-md transition-all">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                {podiumItems.map(({ leader, rank }) => {
                  ...
                  return (
                    <div
                      key={leader.userId}
                      className={`bg-white rounded-3xl p-6 border ${isFirst ? "border-2 border-yellow-400/40 shadow-xl z-10 md:pb-8" : "border-[var(--br-surface-strong)]/60 shadow-sm"} relative transition-all hover:-translate-y-2 flex flex-col items-center text-center`}
                    >
              ...
              <div className="flex justify-between">
                {weekActivity.map((day, idx) => (
                  <div key={idx} className="flex flex-col items-center gap-2">
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all ${day.active ? "bg-orange-500 text-white shadow-sm" : "bg-[var(--br-canvas-elevated)] border-2 border-transparent"}`}>
                      {day.active ? "✓" : ""}
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-[var(--br-surface-strong)]/60">
              ...
              <div className="grid grid-cols-4 gap-3">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--br-chart-primary)] to-[var(--br-brand)] text-white flex items-center justify-center shadow-md mb-2 transition-transform hover:scale-110 cursor-help" title="Quiz Master: complete quizzes to level up">
