...
export default function Loading() {
  return (
    <div className="grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)_280px]">
      <div className="hidden flex-col gap-2 rounded-2xl border border-gray-200 bg-white p-3 lg:flex">
      ...
      <div className="hidden flex-col gap-3 rounded-2xl border border-gray-200 bg-white p-4 lg:flex">
