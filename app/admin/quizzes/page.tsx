              ...
              <tr key={quiz.id} className="border-t border-black/10">
                ...
                <td className="p-3">
                  <div className="flex gap-2">
                    ...
                    <a href={`/quizzes/${quiz.id}/print`} target="_blank" rel="noopener noreferrer" className="rounded-md border border-black/15 p-2 hover:bg-black/5 text-slate-600" title="Print / PDF" aria-label="Print / PDF"><Printer size={16} /></a>
