    ...
    >
      ...
      <div className="flex min-w-0 gap-5">
        <section className="flex min-w-0 flex-1 flex-col gap-5">
          ...
          <DashboardCard className="overflow-hidden"><div className="grid lg:grid-cols-[.9fr_1.1fr]"><div className="border-b border-[#ECECF5] p-5 lg:border-b-0 lg:border-r md:p-6"><SectionHeader title="Your Schedule" href="/live-classes" small /><ScheduleGrid assignments={assignments ?? []} liveClasses={liveClasses ?? []} /></div><div className="p-5 md:p-6"><SectionHeader title="Today’s Agenda" href="/assignments" small /><AgendaList assignments={assignments ?? []} liveClasses={liveClasses ?? []} /></div></div></DashboardCard>
