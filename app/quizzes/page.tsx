          ...
          <div className="relative self-start overflow-hidden rounded-[24px] bg-gradient-to-br from-[#1A1060] via-[#0C1945] to-[#0E1F5A] p-4 text-white shadow-[0_16px_48px_rgba(20,23,80,.25)] sm:p-5">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <a href="#quiz-library" className="inline-flex items-center gap-2 rounded-[13px] bg-white px-4 py-2.5 text-sm font-extrabold text-[#6C3BFF]">
                  Browse quiz library
                </a>
                <a href="/leaderboard" className="inline-flex items-center gap-2 rounded-[13px] border border-white/20 bg-white/10 px-4 py-2.5 text-sm font-extrabold text-white">
                  View leaderboard
                </a>
              </div>
            </div>
