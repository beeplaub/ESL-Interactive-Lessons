        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(330px,.85fr)]">
          <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#1A1060] via-[#0C1945] to-[#0E1F5A] p-6 text-white shadow-[0_18px_52px_rgba(20,23,80,.28)] sm:p-9 lg:p-11">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mt-6 max-w-3xl text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl">{test.title}</h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-white/68 sm:text-base">{test.description}</p>
              ...
              <Link href={startHref} className="mt-8 inline-flex items-center gap-2 rounded-[14px] bg-white px-6 py-3.5 text-sm font-extrabold text-[#6C3BFF] shadow-[0_10px_28px_rgba(0,0,0,.16)]">
