...
- Aligned slide-list access with active/completed course enrollment, preserving roster and teacher access.
...
- Five actual-route tests: course enrollment without roster membership, canonical slide references, roster membership, outsider/signed-out denial, and denial of learner writes.
