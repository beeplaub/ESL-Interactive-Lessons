...
- Use only these block_type values: TEXT, HEADING, BULLETS, QUOTE, CALLOUT, IMAGE, IMAGE_TEXT, IMAGE_PAIR, AUDIO, VIDEO, VOCABULARY, GRAMMAR, READING, DIALOGUE, FLASHCARD, TABLE, COMMON_MISTAKE, CONTRAST_PAIR, DIVIDER.
