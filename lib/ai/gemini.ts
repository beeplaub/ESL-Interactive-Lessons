...
- Use only these block_type values: TEXT, HEADING, BULLETS, INSTRUCTION, REVIEW_CHECKLIST, QUOTE, CALLOUT, IMAGE, IMAGE_TEXT, IMAGE_PAIR, AUDIO, VIDEO, VOCABULARY, GRAMMAR, READING, DIALOGUE, FLASHCARD, TABLE, COMMON_MISTAKE, CONTRAST_PAIR, TONGUE_TWISTER, STEPS, DIVIDER, SPACE.
