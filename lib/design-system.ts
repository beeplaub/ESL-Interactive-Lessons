...
export function platformStyleVariables(settings: PlatformStyleSettings) {
  ...
  return {
    ...
    "--br-success-soft": `color-mix(in srgb, ${settings.success} 12%, ${settings.surface})`,
    "--br-warning": settings.warning,
    "--br-warning-soft": `color-mix(in srgb, ${settings.warning} 14%, ${settings.surface})`,
    "--br-danger": settings.danger,
    "--br-danger-soft": `color-mix(in srgb, ${settings.danger} 10%, ${settings.surface})`,
    "--br-info": settings.info,
    "--br-info-soft": `color-mix(in srgb, ${settings.info} 11%, ${settings.surface})`,
    "--br-brand-soft": `color-mix(in srgb, ${settings.brandPrimary} 11%, ${settings.surface})`,
