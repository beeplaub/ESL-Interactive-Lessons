  ...
  return (
    <div className="mt-6 space-y-4">
      ...
      <button
        ...
        disabled={isPending}
        onClick={submit}
        className="w-full rounded-xl bg-violetglow px-4 py-2.5 text-sm font-bold text-on-dark shadow-[var(--br-shadow)] hover:bg-[var(--br-brand-strong)] disabled:opacity-60 transition"
      >
