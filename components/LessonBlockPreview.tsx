          ...
          <div ref={imageFrameRef} className="relative overflow-hidden rounded-lg bg-surface-muted">
            ...
            {current ? (
              <div className="absolute inset-0 z-10 grid place-items-center p-2 sm:p-4" role="presentation">
                <div className="max-h-[72%] w-[72%] max-w-[16rem] overflow-y-auto rounded-xl border border-[var(--br-info)] bg-white p-2.5 text-[12px] shadow-2xl sm:max-h-[82%] sm:w-[min(78%,20rem)] sm:max-w-none sm:rounded-2xl sm:p-4 sm:text-base" role="dialog" aria-label={asString(current.label) || `Marker ${current.index}`}>
