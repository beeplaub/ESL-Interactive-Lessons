      ...
      {streak > 0 ? (
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex max-w-[168px] items-center gap-1.5 whitespace-nowrap rounded-full bg-gradient-to-br from-[var(--br-achievement)] to-[#FF8C00] py-1.5 pl-3 pr-7 text-on-dark shadow-[var(--br-shadow)]"
          >
